...
1. setup your app as  
    ...
    heroku buildpacks:add https://github.com/CloudVisionApps/HerokuBuildpackTesseract
    ```
...
## Note
This fork solves the [issue](https://github.com/CloudVisionApps/HerokuBuildpackTesseract/issues/1) of the missing libraries `libtiff4` and `libjpeg62`.
